...
class MainPage extends React.Component {
	...
	***********************************************************/
    ...
    /*****************************************************************
	* HTML to be rendered.	 
	* Has 3 links.  1 to have the user login.  The 2nd to have the user logout.  The 3rd is a link to a LoggedInPage component.
	* In addition to that it just displays what I used in this project, ie dependencies, to get it to work.
	* 
	* For more information on the Link tag see https://v5.reactrouter.com/web/api/Link
	* For more information on the Outlink tag see https://reactrouter.com/en/main/components/outlet
    *****************************************************************/
	render() {
